<template>
    <div>
        ...
        <Heroe v-if="page.heroe.title" :content="page.heroe" col="10" />

        <ImageLeftContentRight v-if="page.image_left_content_right" :content="page.image_left_content_right" columnsImage="5" columnsText="7" />

        <Footer :page="page.call_to_action" :optionsPage="optionsPage" :menuQuickLinks="menuQuickLinks" :menuServices="menuServices" />
    </div>
</template>
