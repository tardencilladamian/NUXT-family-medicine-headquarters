<template>
  <div class="form-group">
    <div class="control">
      ...
      <Cleave class="form-control" :class="isInputDirty" :id="uid" :options="cleave" :raw="false" v-model="inputValue" @input="onChange" aria-required="true" placeholder="MM/DD/YYYY" />
